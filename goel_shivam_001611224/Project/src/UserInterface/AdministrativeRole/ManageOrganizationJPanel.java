    ...
    public ManageOrganizationJPanel(JPanel userProcessContainer,OrganizationDirectory directory) {
     ...
     private void populateCombo(){
        ...
        for (Organization.Type type : Organization.Type.values()){
            if (!type.getValue().equals(Organization.Type.OrganBankAdmin.getValue()) 
                    && !type.getValue().equals(Organization.Type.LabAssistant.getValue())
                    && !type.getValue().equals(Organization.Type.OrganBankReceptionist.getValue())
